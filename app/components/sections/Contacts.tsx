      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full bg-green-500/10 px-4 py-2 text-sm font-medium text-green-600 dark:text-green-400 border border-green-500/20"
          >
