    ...
    >
      ...
      <div className="section-shell relative z-10">
        <motion.div
          ...
          className="grid gap-x-10 gap-y-8 md:grid-cols-[0.42fr_0.58fr] md:items-start"
        >
          <div>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              {education.coursework.map((course) => (
                <Badge key={course} variant="outline" className="justify-start whitespace-normal px-3 py-2 text-left">
                  {course}
                </Badge>
              ))}
            </div>
